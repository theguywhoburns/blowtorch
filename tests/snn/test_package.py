...
def test_snn_public_exports_match_all():
    ...
    assert crematorium.snn.__all__ == expected
...
def test_reset_module_is_exportable():
    ...
    assert reset_module.subtract_reset is crematorium.snn.subtract_reset
    assert reset_module.zero_reset is crematorium.snn.zero_reset
    assert reset_module.hard_zero_reset is crematorium.snn.hard_zero_reset
    assert reset_module.no_reset is crematorium.snn.no_reset
